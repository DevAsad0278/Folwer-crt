...
const Tiktokpayment = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      console.log("TikTok Payment Data:", formData);
      ...
      <div className="max-w-3xl w-full bg-white rounded-xl shadow-xl overflow-hidden">
        ...
        <div className="bg-indigo-600 text-white p-6 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-bold">Secure Payment Gateway</h1>
          </div>
          <button
            onClick={() => navigate(-1)}
        ...
        <div className="grid md:grid-cols-2 gap-8 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all font-medium flex items-center justify-center gap-2"
            >
              <FaCreditCard />
              Confirm Payment
            </button>
            ...
            <div className="space-y-3">
              ...
              <div className="mt-4">
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <FaLink className="flex-shrink-0 text-indigo-600" />
