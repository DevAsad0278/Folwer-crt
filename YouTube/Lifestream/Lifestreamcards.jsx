...
const LifestreamCards = () => {
  const navigate = useNavigate();

  const plans = [
    {
      name: "Buy 1000 Youtube Live Stream Views",
      value: "livestream-1",
      type: "livestream",
      price: 8.5,
      features: [
    ...
    {
      name: "Buy 1500 Youtube Live Stream Views",
      value: "livestream-2",
      type: "livestream",
      price: 13.0,
      features: [
        "13 Min for 1.5k Users",
        "100% Real and Active",
        "Safe and Secure",
      ],
    },
    {
      name: "Buy 2000 Youtube Live Stream Views",
      value: "livestream-3",
      type: "livestream",
      price: 22.5,
      features: [
    ...
    {
      name: "Buy 2500 Youtube Live Stream Views",
      value: "livestream-4",
      type: "livestream",
      price: 29.0,
      features: [
        "13 Min for 2.5k Users",
        "100% Real and Active",
        "Safe and Secure",
      ],
    },
    {
      name: "Buy 5000 Youtube Live Stream Views",
      value: "livestream-5",
      type: "livestream",
      price: 42.0,
      features: [
    ...
    {
      name: "Buy 10000 Youtube Live Stream Views",
      value: "livestream-6",
      type: "livestream",
      price: 75.0,
      features: [
        "13 Min for 10k Users",
        "100% Real and Active",
        "Safe and Secure",
      ],
    },
...
export default LifestreamCards;
