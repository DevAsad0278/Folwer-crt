...
import FacebookFollowerscontent from "./FacebookFollowers-content";

const CardsFacebookFollowers = () => {
  const navigate = useNavigate();

  const plans = [
    {
      name: "Buy 250 Facebook Followers",
      value: "fbfollowers-1",
      type: "fbfollowers", // Add type
      price: 7.0,
      features: [
        "Sustainable Service",
        "100% English Names",
    ...
    {
      name: "Buy 500 Facebook Followers",
      value: "fbfollowers-2",
      type: "fbfollowers",
      price: 13.0,
      features: [
    ...
    {
      name: "Buy 1000 Facebook Followers",
      value: "fbfollowers-3",
      type: "fbfollowers",
      price: 22.0,
      features: [
    ...
    {
      name: "Buy 2500 Facebook Followers",
      value: "fbfollowers-4",
      type: "fbfollowers",
      price: 39.0,
      features: [
    ...
    {
      name: "Buy 5000 Facebook Followers",
      value: "fbfollowers-5",
      type: "fbfollowers",
      price: 60.0,
      features: [
  ...
  const handleBuyNow = (plan) => {
    navigate("/BuyNowFacebook", { state: { selectedPlan: plan } });
  };
  ...
  return (
    <div className="w-full min-h-screen p-10">
      ...
      <FacebookFollowerscontent />
    </div>
  );
};

export default CardsFacebookFollowers;
