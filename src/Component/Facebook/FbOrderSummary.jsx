      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={() => navigate("/FbPayment", { state: { formData } })}
              className="flex-1 flex items-center justify-center gap-2 py-2 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm"
            >
              <FaCreditCard />
              Proceed to Payment
            </button>
