...
import InstaStoryViewscontent from "./InstaStoryViews-content";

const CardsStoryViews = () => {
  const navigate = useNavigate();

  const plans = [
    {
      name: "Buy 250 Instagram Story Views",
      value: "story-1",
      type: "story", // Add type
      price: 4.5,
      features: [
    ...
    {
      name: "Buy 500 Instagram Story Views",
      value: "story-2",
      type: "story",
      price: 7.5,
      features: [
    ...
    {
      name: "Buy 1000 Instagram Story Views",
      value: "story-3",
      type: "story",
      price: 9.0,
      features: [
    ...
    {
      name: "Buy 2500 Instagram Story Views",
      value: "story-4",
      type: "story",
      price: 15.0,
      features: [
    ...
    {
      name: "Buy 5000 Instagram Story Views",
      value: "story-5",
      type: "story",
      price: 30.0,
      features: [
    ...
    {
      name: "Buy 10000 Instagram Story Views",
      value: "story-6",
      type: "story",
      price: 55.0,
      features: [
  ...
  return (
    <div className="w-full min-h-screen p-10">
      ...
      <InstaStoryViewscontent />
    </div>
  );
};

export default CardsStoryViews;
