...
const PrivacyPolicy = () => {
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Follower Cart.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Follower Cart, accessible from{" "}
            <a
              href="https://followerscart.com"
      ...
      <ul>
        <li>By phone number: +92 341 3732952</li>
      </ul>
    </div>
  );
};
