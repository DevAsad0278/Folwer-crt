...
import Videosharecontent from "./Videosharecontent";

const Videosharecards = () => {
  const navigate = useNavigate();
  const plans = [
    {
      name: "Buy 50 Youtube Video Shares",
      value: "videoshare-1",
      type: "videoshare",
      price: 3.99,
      features: ["24 Hours", "Safe and Secure", "Money Back Guarantee"],
    },
    {
      name: "Buy 100 Youtube Video Shares",
      value: "videoshare-2",
      type: "videoshare",
      price: 7.0,
      features: ["24 Hours", "Safe and Secure", "Money Back Guarantee"],
    ...
    {
      name: "Buy 300 Youtube Video Shares",
      value: "videoshare-3",
      type: "videoshare",
      price: 13.0,
      features: ["24 Hours", "Safe and Secure", "Money Back Guarantee"],
    ...
    {
      name: "Buy 500 Youtube Video Shares",
      value: "videoshare-4",
      type: "videoshare",
      price: 20.0,
      features: ["48 Hours", "Safe and Secure", "Money Back Guarantee"],
    },
    {
      name: "Buy 1000 Youtube Video Shares",
      value: "videoshare-5",
      type: "videoshare",
      price: 37.0,
      features: ["48 Hours", "Safe and Secure", "Money Back Guarantee"],
    ...
    {
      name: "Buy 2500 Youtube Video Shares",
      value: "videoshare-6",
      type: "videoshare",
      price: 60.0,
      features: ["3-4 Hours", "Safe and Secure", "Money Back Guarantee"],
    },
  ];
...
export default Videosharecards;
