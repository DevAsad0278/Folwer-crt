...
import Videoviewcontent from "./Videoviewscontent";

const Videoviewscards = () => {
  const navigate = useNavigate();
  const plans = [
    {
      name: "Buy 500 Youtube Views",
      value: "videoviews-1",
      type: "videoviews",
      price: 3.99,
      features: [
    ...
    {
      name: "Buy 10000 Youtube Views",
      value: "videoviews-6",
      type: "videoviews",
      price: 45.0,
      features: ["3-4 Days", "Safe and Secure Service", "Money Back Guarantee"],
    },
    {
      name: "Buy 20000 Youtube Views",
      value: "videoviews-7",
      type: "videoviews",
      price: 60.0,
      features: ["4-6 Days", "Safe and Secure Service", "Money Back Guarantee"],
    },
    {
      name: "Buy 50000 Youtube Views",
      value: "videoviews-8",
      type: "videoviews",
      price: 120.0,
      features: ["1 Week", "Safe and Secure Service", "Money Back Guarantee"],
    },
    {
      name: "Buy 100000 Youtube Views",
      value: "videoviews-9",
      type: "videoviews",
      price: 169.0,
      features: ["10 Days", "Safe and Secure Service", "Money Back Guarantee"],
    },
  ];
          ...
          {plans.map((plan, idx) => (
            <SwiperSlide key={idx}>
              <div className="relative flex flex-col items-stretch rounded-2xl p-6 border-2 border-[#001233] bg-white shadow-lg w-full sm:w-[90%] md:w-[95%] mx-auto">
                <div className="text-center bg-[#001233] py-5 rounded-bl-full rounded-tl-full rounded-tr-full rounded-br-full">
...
export default Videoviewscards;
