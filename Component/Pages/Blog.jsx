...
const Blog = ({ image, date, CardTitle, CardDescription }) => {
  return (
          ...
          <div class="bg-white rounded-sm overflow-hidden">
            ...
            <div class="p-6">
              ...
              <a
                ...
                class="mt-6 inline-block px-4 py-2 rounded-sm tracking-wider bg-orange-500 hover:bg-orange-600 text-white text-[13px] font-medium"
              >
                Read More
              </a>
            </div>
