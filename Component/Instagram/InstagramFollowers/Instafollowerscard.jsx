...
import InstagramFollowerscontent from "./InstagramFollowers-content";

const Instafollowerscards = () => {
  const navigate = useNavigate();

  const plans = [
    {
      name: "Buy 100 Instagram Followers",
      value: "followers-1",
      type: "followers",
      price: 1.75,
      features: [
    ...
    {
      name: "Buy 250 Instagram Followers",
      value: "followers-2",
      type: "followers",
      price: 3.5,
      features: [
    ...
    {
      name: "Buy 500 Instagram Followers",
      value: "followers-3",
      type: "followers",
      price: 7.0,
      features: [
    ...
    {
      name: "Buy 1000 Instagram Followers",
      value: "followers-4",
      type: "followers",
      price: 11.5,
      features: [
    ...
    {
      name: "Buy 2500 Instagram Followers",
      value: "followers-5",
      type: "followers",
      price: 32.0,
      features: [
    ...
    {
      name: "Buy 5000 Instagram Followers",
      value: "followers-6",
      type: "followers",
      price: 57.0,
      features: [
    ...
    {
      name: "Buy 10000 Instagram Followers",
      value: "followers-7",
      type: "followers",
      price: 109.0,
      features: [
  ...
  return (
    <div className="w-full min-h-screen p-10">
      ...
      <InstagramFollowerscontent />
    </div>
  );
};

export default Instafollowerscards;
