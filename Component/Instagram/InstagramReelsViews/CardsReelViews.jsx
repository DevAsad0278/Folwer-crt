...
import InstaReelsViewscontent from "./InstaReelsViews-content";

const CardsReelsViews = () => {
  const navigate = useNavigate();

  const plans = [
    {
      name: "Buy 250 Instagram Reels Views",
      value: "reels-1",
      type: "reels", // Add type
      price: 1.0,
      features: [
    ...
    {
      name: "Buy 500 Instagram Reels Views",
      value: "reels-2",
      type: "reels",
      price: 2.0,
      features: [
    ...
    {
      name: "Buy 1000 Instagram Reels Views",
      value: "reels-3",
      type: "reels",
      price: 3.99,
      features: [
    ...
    {
      name: "Buy 2500 Instagram Reels Views",
      value: "reels-4",
      type: "reels",
      price: 6.5,
      features: [
    ...
    {
      name: "Buy 5000 Instagram Reels Views",
      value: "reels-5",
      type: "reels",
      price: 13.0,
      features: [
  ...
  return (
    <div className="w-full min-h-screen p-10">
      ...
      <InstaReelsViewscontent />
    </div>
  );
};

export default CardsReelsViews;
